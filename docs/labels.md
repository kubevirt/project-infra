...
| <a id="kind/auto-quarantine" href="#kind/auto-quarantine">`kind/auto-quarantine`</a> | PR was created by the auto-quarantine bot.| label |  [label](https://prow.ci.kubevirt.io/command-help#label) |
