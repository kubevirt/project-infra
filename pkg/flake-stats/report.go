...
func (r FlakeStats) fetchFlakeFinder24hReportsForRecentDays() ([]*flakefinder2.Params, error) {
	var recentFlakeFinderReports []*flakefinder2.Params
...
func (r FlakeStats) fetchFlakeFinder24hReportData(targetReportDate time.Time) (*flakefinder2.Params, error) {
	reportJSONURL, err := flakefinder2.GenerateReportURL(r.reportOpts.Org, r.reportOpts.Repo, targetReportDate, flakefinder2.DateRange24h, "json")
	if err != nil {
	...
	var flakefinderReportData flakefinder2.Params
...
func (r FlakeStats) aggregateTopXTests(recentFlakeFinderReports []*flakefinder2.Params) TopXTests {
	...
	for _, reportData := range recentFlakeFinderReports {
		for i := 0; i < len(reportData.Tests); i++ {
			...
			normalizedTestName := flakefinder2.NormalizeTestName(originalTestName)

			if flakefinder2.IsQuarantineLabelPresent(originalTestName) {
...
func (r FlakeStats) aggregateFailuresPerJob(reportData *flakefinder2.Params, originalTestName string, testNamesByTopXTests map[string]*TopXTest, normalizedTestName string) {
...
func (r FlakeStats) aggregateAllFailuresPerTest(currentTopXTest *TopXTest, jobFailures *flakefinder2.Details) {
	currentTopXTest.AllFailures.add(jobFailures.Failed)
}

func (r FlakeStats) aggregateFailuresPerTestPerDay(currentTopXTest *TopXTest, reportData *flakefinder2.Params, jobFailures *flakefinder2.Details) {
...
func (r FlakeStats) aggregateFailuresPerTestPerLane(currentTopXTest *TopXTest, jobName string, jobFailures *flakefinder2.Details) {
...
func (r FlakeStats) writeReport(overallFailures *TopXTest, topXTests TopXTests) error {
	...
	err = flakefinder2.WriteTemplateToOutput(htmlTemplate, templateData, htmlReportOutputWriter)
	if err != nil {
