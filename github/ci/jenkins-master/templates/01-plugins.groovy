...
def pluginParameter="ghprb job-dsl github-oauth swarm throttle-concurrents publish-over-ssh build-timeout xunit test-results-analyzer ws-cleanup postbuildscript"
